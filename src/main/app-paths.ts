...
export function buildDefaultSettings(dataRoot = defaultDataRoot()): AppSettings {
  ...
  return {
    ...
    visionMinimumConfidence: 0.82,
    researchProvider: 'disabled',
    researchBaseUrl: 'https://api.tavily.com',
    researchEndpointTrust: 'managed',
    researchSearchDepth: 'basic',
    researchMaxResultsPerQuery: 5,
    youtubeCategoryId: '19',
    youtubePlaylistId: '',
    youtubePrivacy: 'private',
    youtubeSyntheticMediaDisclosure: true,
    channelName: '',
    channelShort: 'TRAVEL',
